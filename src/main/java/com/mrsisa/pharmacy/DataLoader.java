...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Appointment a90 = createAppointmentWhichTookPlace("04.03.2019. 11:00", "04.03.2019. 12:45", 1000.0, ec2a, p1, new Report("dijagnostika"));
        Appointment a91 = createAppointmentWhichTookPlace("04.03.2020. 11:00", "04.03.2020. 13:45", 1200.0, ec2b, p1, new Report("dijagnostika"));
        Appointment a92 = createAppointmentWhichTookPlace("04.03.2021. 11:00", "04.03.2021. 18:45", 1300.0, ec2c, p1, new Report("dijagnostika"));
        ...
        MedicineReservation medicineReservation5 = createIssuedMedicineReservation(650.0, "28.03.2020. 10:20", "05.04.2020. 10:00", jankovic, p1, new MedicineReservationItem(3, aspirin, 290.0));
        MedicineReservation medicineReservation6 = createIssuedMedicineReservation(850.0, "23.03.2020. 10:20", "05.06.2020. 10:00", jankovic, p1, new MedicineReservationItem(3, brufen, 390.0));
        MedicineReservation medicineReservation7 = createIssuedMedicineReservation(350.0, "21.03.2020. 10:20", "05.07.2020. 10:00", benu, p1, new MedicineReservationItem(3, aspirin, 540.0));
        MedicineReservation medicineReservation8 = createIssuedMedicineReservation(450.0, "28.03.2020. 10:20", "05.04.2020. 10:00", jankovic, p1, new MedicineReservationItem(3, aspirin, 290.0));
        MedicineReservation medicineReservation9 = createIssuedMedicineReservation(250.0, "23.03.2020. 10:20", "05.11.2020. 10:00", jankovic, p1, new MedicineReservationItem(2, brufen, 390.0));
        MedicineReservation medicineReservation10 = createIssuedMedicineReservation(150.0, "21.03.2020. 10:20", "05.12.2020. 10:00", benu, p1, new MedicineReservationItem(1, hepalpan, 540.0));
    ...
    private MedicineReservation createIssuedMedicineReservation(Double price, String reservedAt, String reservationDeadline, Pharmacy pharmacy, Patient patient, MedicineReservationItem... medicineReservationItems) {
        final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd.MM.yyyy. HH:mm");
        MedicineReservation medicineReservation = new MedicineReservation(price, LocalDateTime.parse(reservedAt, formatter), LocalDateTime.parse(reservationDeadline, formatter), ReservationStatus.PICKED, pharmacy, patient);
        Arrays.stream(medicineReservationItems).forEach(medicineReservationItem -> {
            medicineReservationItem.setReservation(medicineReservation);
            medicineReservation.getReservedMedicines().add(medicineReservationItem);
        });
