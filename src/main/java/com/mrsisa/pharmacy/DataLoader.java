...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        var ibisLocation = new Location(45.2630180312307, 19.83046478671768, new Address(SERBIA, NOVI_SAD, "Bulevar oslobodjenja", "4a", ZIP_CODE));
        ...
        var ec1 = createEmploymentContract(dm3, benu, "22.02.2021.", getWorkingHours("09:00", "12:00"));
        ...
        // ##################################################################################################################
        var ec3 = createEmploymentContract(ph2, benu, "22.01.2021.", getWorkingHours("09:00", "17:00"));
        var ec4 = createEmploymentContract(dm1, benu, "21.03.2021.", getWorkingHours("09:00", "14:00"));
        var ec5 = createEmploymentContract(dm1, drMax, "25.03.2021.", getWorkingHours("15:00", "17:00"));
        var ec6 = createEmploymentContract(ph3, drMax, "23.03.2021.", getWorkingHours("09:00", "17:00"));
        var ec7 = createEmploymentContract(ph4, drMax, "27.03.2021.", getWorkingHours("09:00", "17:00"));
        ...
        var a39 = createAvailableAppointment("23.06.2021. 09:40", "23.06.2021. 12:37",2800,ec2aa);
        var a40 = createAvailableAppointment("23.06.2021. 12:35", "23.06.2021. 15:31",2800,ec6);
        var a41 = createAvailableAppointment("23.06.2021. 09:40", "23.06.2021. 12:45",2800,ec7);
        var a42 = createAvailableAppointment("23.06.2021. 12:51", "23.06.2021. 15:32",2800,ec7);
        var a43 = createAvailableAppointment("23.06.2021. 09:40", "23.06.2021. 12:22",3500,ec10);
        var a44 = createAvailableAppointment("23.06.2021. 12:15", "23.06.2021. 15:33",3500,ec10);

        // Create pharmacist appointments 22.06.2021 3 per day overlapping 2 pharmacies that are already booked
        var a49 = createBookedAppointment("23.06.2021. 09:40", "23.06.2021. 12:46",2800,ec2a, p1);
        var a50 = createBookedAppointment("08.05.2021. 02:30", "08.05.2021. 22:30",2800,ec2aa, p1);
        var a51 = createBookedAppointment("23.06.2021. 09:40", "23.06.2021. 12:57",2800,ec2c, p3);
        var a52 = createBookedAppointment("23.06.2021. 12:19", "23.06.2021. 15:34",2800,ec2d, p4);
        var a53 = createBookedAppointment("23.06.2021. 09:40", "23.06.2021. 12:53",3500,ec2e, p5);
        var a54 = createBookedAppointment("23.06.2021. 13:30", "23.06.2021. 15:35",3500,ec2f, p1);
